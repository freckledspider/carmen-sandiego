...
SELECT code, name FROM country WHERE name ILIKE '%vatican%';
-- code |             name
--------+-------------------------------
...
SELECT countrycode, language, percentage FROM countrylanguage WHERE language = 'Ita
lian' AND percentage = '100';
-- countrycode | language | percentage
---------------+----------+------------
-- SMR         | Italian  |        100

SELECT name, code, region FROM country WHERE code = 'SMR';
--    name    | code |     region
--------------+------+-----------------
...
SELECT name, id FROM city WHERE id = '211';
--    name    | id
--------------+-----
-- Bras∩┐╜lia | 211
